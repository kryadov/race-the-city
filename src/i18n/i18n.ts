...
const MESSAGES: Record<Lang, Dict> = {
  en: {
    ...
    'menu.title': 'Settings',
    'about.title': 'About',
    'about.description': 'Race the City — free-roam driving through a real city, built live from OpenStreetMap over real terrain. Pick a place, pick a car, and drive.',
  ...
  ru: {
    ...
    'about.description': 'Race the City — свободная езда по настоящему городу, собранному на лету из OpenStreetMap поверх реального рельефа. Выбери место, машину и катайся.',
